...
REF_WORK_DIR_PATH="${HOME}/work/anduinos-iso-builder-remix-advance-kde-plasma"
...
echo "[Next Step]: cd ~/work/anduinos-iso-builder-remix-advance-kde-plasma/iso-profile
"
echo
